...
<form action="employeechangepassword.php" align="center" width ="50%" method="post" style="padding-top:50px;">
  ...
  <tr>
  <td>
    <b>Your Father's Name : </td>
    <td><b><?php echo $data['fathername']; ?></td>
</tr>
  <tr>
  <td>
    <b>Address : </td>
    <td><b><?php echo $data['address']; ?></td>
</tr>
<tr>
  <td>
    <b>Registered Mobile : </td>
    <td><b><?php echo $data['mobile']; ?></td>
</tr>
  <tr>
  <td>
    <b>Date of birth : </td>
    <td><b><?php echo $data['DOB']; ?></td>
</tr>
	  <tr>
  <td>
    <b>Date of joining : </td>
    <td><b><?php echo $data['DOJ']; ?></td>
</tr>	  <tr>
  <td>
    <b>Your Username : </td>
